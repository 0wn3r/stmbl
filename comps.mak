...
# F4 LL port pending: LV_SRC_COMPS += src/comps/enc_cmd.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/o_fb.c
...
# F4 LL port pending: LV_SRC_COMPS += src/comps/encm.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/dmm.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/smartabs.c
LV_SRC_COMPS += src/comps/adc.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/enc_fb.c
LV_SRC_COMPS += src/comps/conf.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/res.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/hx711.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/siserial.c
# F4 LL port pending: LV_SRC_COMPS += src/comps/smart_torque.c
